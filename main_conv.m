...
T = 50; % reduce for a faster simulation
...
for RIS = 2
    ...
    for cc = 1:n_chan
        ...
        data_location = strcat('./channels/',num2str(sys.N0)); %mkdir(data_location);
        ...
        figure
        plot(1:n_iter, minrate(:,cc),linestyle{RIS+1}, 'LineWidth', 1.4); hold on
    end
end
xlabel('iteration numbers')
ylabel('Minimum rate [bits/s]')
legend('No RIS','Passive RIS','Hybrid RIS','Active RIS')